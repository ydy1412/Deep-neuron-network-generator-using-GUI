...
from Frame_Canvas.Main_Frame import StartFrame
...
class Start_Frame(StartFrame):

    def __init__(self, parent):
        StartFrame.__init__(self, parent, id=wx.ID_ANY, title=u"Neuron Network Generator", pos=wx.DefaultPosition,
